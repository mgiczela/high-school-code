/*************************************************************************
 * Name        : Keith Vertanen - modified by michal giczela
 * Username    : kvertanen
...
public class GemGame 
{
	...
	public static void main(String [] args)
	{
		...
		while ((player1.size() < MAX_GEMS) && (player2.size() < MAX_GEMS))
		{
		    ...
		    StdDraw.picture(0.5, 0.5, "background.png", 2.0, 2.0);
			...
			// Background images for each player
			...
			StdDraw.setFont(new Font("Comic Sans MS", Font.BOLD, 16));
		...
		StdDraw.setPenColor(StdDraw.RED);
        StdDraw.setFont(new Font("Comic Sans MS", Font.BOLD, 24));
        if (score1 == score2)
        	StdDraw.text(0.5, SCORE_Y, "Tie game!");
        else if (score1 > score2)
        	StdDraw.text(0.5, SCORE_Y, player1Name +" wins!");
        else 
        	StdDraw.text(0.5, SCORE_Y, player2Name + " wins!");
