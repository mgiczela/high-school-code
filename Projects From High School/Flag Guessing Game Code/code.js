...
function generateNewQuestion() {
   ...
   if (txtForButton1.name.length > 12) //this makes it so we can shrink the text only if rlly long name in html part
   {
   ...
   if (txtForButton2.name.length > 12) //this makes it so we can shrink the text only if rlly long name in html part
   {
   ...
   if (txtForButton3.name.length > 12) //this makes it so we can shrink the text only if rlly long name in html part
   {
   ...
   if (txtForButton4.name.length > 12) //this makes it so we can shrink the text only if rlly long name in html part
   {
...
scoreboard.innerHTML = `${numCorrect}/${numAnswered}`;
